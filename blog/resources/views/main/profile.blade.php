        ...
        <section class="profile-holder container-fluid">
                <div class="card card-profile">
                    @if($user->id === Auth::user()->id)
                        ...
                        <input type="text" name="image" class="user-info input-edit-avatar card-img-top input-edit-profile" value="Link to your avatar" readonly>

                        <div class="card-body">
                            <div class="personal-details">
                                <input type="text" name="firstName" class="user-info card-title title-one input-edit-profile" value="{{ $user->first_name }}" readonly>
                                <input type="text" name="lastName" class="user-info card-title title-one input-edit-profile" value="{{ $user->last_name }}" readonly>
                            </div>
                            <input type="text" name="occupation" class="user-info text-uppercase grey-text mb-3 input-edit-profile" value="{{ empty($user->occupation) ? "occupation" : $user->occupation }}" readonly>
            ...
            <section class="container-fluid">
                <div class=" text-center p-4 d-flex flex-wrap-reverse">
                    <div class="col-md-7 text-md-left ml-3 mt-3" >
                        ...
                        @if($user->id === Auth::user()->id)
                            <textarea type="text" name="about" class="user-info font-weight-normal input-edit-about input-edit-profile" rows="5" readonly>{{ $user->about }}</textarea>
                        @else
